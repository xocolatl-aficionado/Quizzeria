...
export default async (req, res) => {
  ...
  try {
    ...
    const setQuesSubNull = await qd.setQuestionSubNull(req.body.subject) // Getting the subject name from frontend and passing it to the datalayer to set the questions subjects to null.
