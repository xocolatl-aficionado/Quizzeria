/**
 * Defining NavBar for all the admin pages using Chakra UI Framwork for react
 */
 ...
 * @returns Navigation bar for all the pages for Admin mapped with the values in the Links array
 */
